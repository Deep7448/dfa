...
if __name__ == "__main__":
    ...
    try:
        ...
        # key pair generation
        pubkey = hex(6406275695464030393343642004713663291078772454264881719050301882562911394762727592284133377392577870538346022910387055671854934206707905547614715381459850)
